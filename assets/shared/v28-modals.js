...
(function(global){
  ...
  const SHARE_CONTEXTS = {
    'personal-home': {
      title: ({ kbName }) => `分享 · ${kbName || '我的知识库'}`,
      urlPath: 'k',
      hint: '有链接的飞象老师可查看本知识库'
    },
    'wiki-home': {
      title: ({ kbName }) => `分享 · ${kbName || '团队 Wiki'}`,
      urlPath: 'k',
      hint: '有链接的飞象老师可查看本团队 Wiki'
    },
    'wiki-entry': {
      title: ({ subject }) => `分享 · ${subject || 'Wiki 词条'}`,
      urlPath: 'w',
      hint: '有链接的飞象老师可查看本词条'
    },
    'file-preview': {
      title: ({ subject }) => `分享 · ${subject || '文件'}`,
      urlPath: 'f',
      hint: '有链接的飞象老师可查看本文件'
    }
  };
